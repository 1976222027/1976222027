    ...
    if index < 5:
        ...
        if zhou != 0:
            ...
            if index == 5 - zhou:
                ...
                index = index - (5 - zhou)
    print("今日值班" + time + '===>' + str(jiaban[index]) + "\n")
    return str(jiaban[index])
...
if __name__ == "__main__":
    ...
    my_url = "https://oapi.dingtalk.com/robot/send?access_token=ba35e19ca18333d8efd8ff8da2535ab1915a2457997472c8f60e3578b694e269"
